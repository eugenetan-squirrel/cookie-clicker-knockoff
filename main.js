...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		window.onbeforeunload=function(event)
		{
			...
			if (typeof Game !== 'undefined' && Game.WriteSave) {
				try {
					...
					console.error('Failed to save game before unload:', e);
				}
			}
		...
		window.addEventListener('blur', function() {
			if (typeof Game !== 'undefined' && Game.toSave !== undefined) {
				Game.toSave = true;
			}
		});
		...
		Game.ToggleMods=function()
		{
			Game.toSave=true;
			// Load mods dynamically if the loader is available
			if (typeof window.LoadModsNow === 'function') {
